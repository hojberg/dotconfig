...
let s:style = get(g:, 'hyperlightcolor', 'dark')
let g:colors_name = "hyperlight"
"}}}
...
let s:palette.bg        = {'dark': "#242142",  'light': "#FAFAFA",  'mirage': "#212733"}

let s:palette.comment   = {'dark': "#2c5b60",  'light': "#ABB0B6",  'mirage': "#5C6773"}
let s:palette.markup    = {'dark': "#668d90",  'light': "#F07178",  'mirage': "#F07178"}
let s:palette.constant  = {'dark': "#f9f09b",  'light': "#A37ACC",  'mirage': "#D4BFFF"}
let s:palette.operator  = {'dark': "#aee4c1",  'light': "#E7C547",  'mirage': "#80D4FF"}
let s:palette.tag       = {'dark': "#59bef0",  'light': "#36A3D9",  'mirage': "#5CCFE6"}
let s:palette.regexp    = {'dark': "#2d6971",  'light': "#4CBF99",  'mirage': "#95E6CB"}
let s:palette.string    = {'dark': "#f9f09b",  'light': "#86B300",  'mirage': "#BBE67E"}
let s:palette.function  = {'dark': "#8cd0ab",  'light': "#F29718",  'mirage': "#FFD57F"}
let s:palette.special   = {'dark': "#ab769d",  'light': "#E6B673",  'mirage': "#FFC44C"}
let s:palette.keyword   = {'dark': "#b44858",  'light': "#FF7733",  'mirage': "#FFAE57"}

let s:palette.error     = {'dark': "#7e2b3d",  'light': "#FF3333",  'mirage': "#FF3333"}
...
let s:palette.fg        = {'dark': "#c7b7ac",  'light': "#5C6773",  'mirage': "#D9D7CE"}
